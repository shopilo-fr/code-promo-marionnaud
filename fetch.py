#!/usr/bin/env python3
"""
Recuperation des codes promo Marionnaud depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/marionnaud.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/marionnaud.fr"
STORE_NAME = "Marionnaud"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Marionnaud depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-marionnaud)"
    }
    try:
